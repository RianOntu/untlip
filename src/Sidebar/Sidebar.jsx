...
function Sidebar() {
    return (
        <>
          ...
          <div className="bg-white p-6 hidden md:flex  md:flex-col md:w-52 inset-y-0  shadow-md h-[100vh] ">
          <h1 className='text-2xl font-semibold mt-5 pl-6'>Untlip</h1>
             ...
             <a className='p-6 text-[#9F9EA6]' href=""><i class="fas fa-signal mr-2"></i>Statistics</a>
